const AboutMe = () => (
  <section className="my-40 flex flex-col-reverse lg:flex-row  gap-10 items-center ">
    <div className="flex-1 space-y-4">
      <h3 className="text-3xl md:text-5xl font-semibold text-primary">About Me:</h3>
      <p className="md:text-2xl text-tertiary">Hello my name is Fredrik Tokle, i am 34 years old. Recently I graduated Front-End Development from Noroff School of Technology and Digital Media.</p>
      <p className="md:text-2xl text-tertiary">
