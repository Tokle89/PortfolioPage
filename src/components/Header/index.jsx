...
const Header = () => {
  ...
  return (
    <header className="border-b flex items-center  border-primary h-[100px] relative   ">
      <div className="max-w-7xl w-full text-primary  flex justify-between m-auto items-center px-5 ">
        <Logo />
